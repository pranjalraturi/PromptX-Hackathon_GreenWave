    ...
    >
      ...
      <div className="relative z-10 flex flex-col w-full max-w-7xl min-h-[600px] overflow-hidden shadow-2xl md:flex-row rounded-3xl">
        ...
        <motion.div 
          ...
          style={{
            backgroundImage: "url('https://www.fao.org/fileadmin/user_upload/forest_genetic_resources/images/large_24683_0418.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
        ...
        >
          <div>
            ...
            <motion.div
              ...
              className="mt-20"
            >
              <h1 className="mb-8 text-5xl font-bold md:text-6xl">Join the Movement</h1>
              <p className="text-2xl opacity-90">
                Create your account and become part of a community dedicated to protecting our planet for future generations.
              </p>
            </motion.div>
          </div>
          ...
          >
            <p className="text-lg opacity-80">
              "The Earth is what we all have in common. It is what we are made of and what we live from."
              <br /><span className="italic">— Wendell Berry</span>
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            <h2 className="mb-10 text-4xl font-bold text-gray-800">Create your account</h2>
